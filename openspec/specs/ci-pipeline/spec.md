...
Автоматически проверять каждый push и pull request в основных ветках: сборка CLI-бинарника, прогон unit-тестов с отчётом покрытия, статический анализ golangci-lint — параллельно, с минимальными permissions и разумными таймаутами.
